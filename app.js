...
{ 
	...
	{
		if(lash.lowerCase(posts[i].postTitle)===lash.lowerCase(req.params.postId))
		{
			res.render("posts",{pageContent:posts[i]});
			console.log("rendered post with title",posts[i].postTitle);
			return ;
		}
	}	
